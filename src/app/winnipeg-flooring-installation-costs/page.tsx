...
export default function InstallationCostsPage() {
  return (
    <main style={{ paddingTop: '120px', paddingBottom: '80px', backgroundColor: '#fcfcfc', color: '#121212' }}>
      <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <p style={{ fontSize: '1.25rem', marginBottom: '2rem', lineHeight: 1.6, color: '#333' }}>
        ...
        <div style={{ padding: '2rem', border: '2px solid var(--accent-gold)', borderRadius: '12px', margin: '3rem 0', backgroundColor: 'white' }}>
          <h2 style={{ fontSize: '2rem', marginBottom: '1rem', fontFamily: 'var(--font-heading)', color: '#121212', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '4rem', fontWeight: 800, color: 'var(--accent-gold)', textAlign: 'center', marginBottom: '1rem' }}>
            $0.99<span style={{ fontSize: '1.5rem', color: '#121212' }}>/sq.ft.</span>
          </div>
        ...
        <div style={{ marginTop: '3rem', padding: '2rem', backgroundColor: '#121212', color: 'white', borderRadius: '12px', textAlign: 'center' }}>
